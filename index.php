...
<div class="elab-section alt reveal" id="tarifs">
  ...
  <div class="tarifs-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:24px;align-items:stretch">
    <!-- Plan 1 — Phase 0 (gratuit, fond vert clair) -->
    <div style="background:#EFF6F0;border:1px solid rgba(8,80,65,.15);border-radius:var(--radius-lg);padding:24px;display:flex;flex-direction:column">
      <h4 style="font-family:'Syne',sans-serif;font-size:15px;font-weight:700;color:#085041;margin-bottom:8px">Phase 0</h4>
      <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;color:#085041;margin-bottom:10px">0 FCFA</div>
      <p style="font-size:11.5px;color:var(--text-muted);line-height:1.6;margin-bottom:14px;flex:1">Accès immédiat, sans engagement, pour découvrir la méthode et te faire ton propre avis.</p>
      <ul style="list-style:none;padding:0;margin:0 0 16px;font-size:11px;color:#085041;display:flex;flex-direction:column;gap:6px">
        <li>• 3 modules complets</li>
        <li>• Outil « Radar à Opportunités »</li>
        <li>• Badge « Explorateur Entrepreneurial »</li>
        <li>• Accès au forum communautaire</li>
      </ul>
      <a href="<?= SITE_URL ?>/register.php" class="btn-pricing outline">Commencer maintenant →</a>
    </div>
    <!-- Plan 2 — Séries 1+2 (mise en avant, fond teal) -->
    <div style="background:#085041;color:#fff;border-radius:var(--radius-lg);padding:24px;display:flex;flex-direction:column;position:relative">
      <span style="display:inline-block;background:#D85A30;color:#fff;font-size:9px;font-weight:700;padding:3px 10px;border-radius:100px;margin-bottom:12px;align-self:flex-start">LE PLUS CHOISI</span>
      <h4 style="font-family:'Syne',sans-serif;font-size:15px;font-weight:700;margin-bottom:8px">Séries 1 + 2</h4>
      <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;color:#7fffc4;margin-bottom:10px">15 000 FCFA</div>
      <p style="font-size:11.5px;color:rgba(255,255,255,.75);line-height:1.6;margin-bottom:14px;flex:1">De l'idée à ta première vente. Le cœur du programme pour les étudiants en action.</p>
      <ul style="list-style:none;padding:0;margin:0 0 16px;font-size:11px;color:rgba(255,255,255,.85);display:flex;flex-direction:column;gap:6px">
        <li>• 18 modules (Séries 1 & 2)</li>
        <li>• Tous les templates & outils</li>
        <li>• Coaching mensuel en groupe</li>
        <li>• Certification Université de Parakou</li>
        <li>• Paiement par tranches possible</li>
      </ul>
      <a href="<?= SITE_URL ?>/register.php" class="btn-pricing gold">S'inscrire — Payer en Mobile Money →</a>
    </div>
    <!-- Plan 3 — Parcours Complet (fond blanc) -->
    <div style="background:#fff;border:1.5px solid rgba(0,0,0,.08);border-radius:var(--radius-lg);padding:24px;display:flex;flex-direction:column">
      ...
      <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;color:var(--navy);margin-bottom:10px">25 000 FCFA</div>
      <p style="font-size:11.5px;color:var(--text-muted);line-height:1.6;margin-bottom:14px;flex:1">Les 30 modules, le coaching 1:1, et l'accès au réseau alumni d'entrepreneurs béninois.</p>
      <ul style="list-style:none;padding:0;margin:0 0 16px;font-size:11px;color:var(--navy);display:flex;flex-direction:column;gap:6px">
        <li>• 30 modules complets</li>
        <li>• Coaching individuel mensuel</li>
        <li>• Accès réseau alumni</li>
        <li>• Certificat mention Excellente</li>
        <li>• Mise en relation partenaires</li>
      </ul>
