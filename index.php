...
.elab-hero-overlay { position: absolute; inset: 0; background: rgba(10,92,70,0.5); }
...
<div class="elab-nav-mobile">
  ...
  <?php else: ?>
    ...
    <a href="<?= SITE_URL ?>/register.php" style="color:var(--gold);font-weight:700">S'inscrire →</a>
  <?php endif; ?>
</div>
...
<div class="elab-hero">
  ...
  <?php else: ?>
    <img src="assets/images/6.jpeg" alt="Étudiant entrepreneur béninois" loading="eager" class="elab-hero-img">
  <?php endif; ?>
  ...
  <div class="elab-hero-content">
    <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.2);border-radius:100px;padding:6px 16px;color:rgba(255,255,255,0.9);font-size:13px;">
      <span style="width:7px;height:7px;background:#4dff9e;border-radius:50%;display:inline-block;"></span> Inscrivez-vous dès maintenant.
    </div>
    ...
    <p style="font-size:15px;color:rgba(255,255,255,.75);line-height:1.75;max-width:560px;margin:0 auto 28px">
      <?= $heroSlide && $heroSlide['sous_titre'] ? h($heroSlide['sous_titre']) : 'Le premier parcours en ligne conçu pour les étudiants, lycéens et apprentis qui veulent créer leur activité avant même d\'avoir leur diplôme.' ?>
    </p>
...
<!-- TRUST BAR -->
<div class="trust-bar">
  <div class="trust-item"><i class="ti ti-certificate"></i> Certificat cosigné par les plus grandes Universités du Bénin</div>
...
<div class="elab-section reveal" id="parcours">
  ...
  <div class="parcours-grid" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-top:24px">
    <div style="background:var(--navy);color:#fff;border-radius:var(--radius-lg);padding:22px">
      ...
      <h4 style="font-family:'Syne',sans-serif;font-size:15px;font-weight:700;margin-bottom:8px">Phase 0 — Onboarding</h4>
      ...
      <p style="font-family:'Syne',sans-serif;font-size:15px;font-weight:700;color:#7fffc4">Gratuit</p>
    </div>
...
<div class="elab-section reveal" id="temoignages" style="background:#fff">
  ...
  <div class="sec-title">Des entrepreneurs qui ont franchi le pas.</div>
  ...
  <div class="temoignages-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:24px">
    ...
    <div style="background:#fff;border-radius:var(--radius-lg);padding:26px;border:1px solid rgba(0,0,0,.06);display:flex;flex-direction:column;gap:18px;box-shadow:0 2px 12px rgba(0,0,0,.04)">
      ...
      <div style="display:flex;align-items:center;gap:14px;margin-top:auto">
        ...
        <?php else: ?>
          <div style="width:52px;height:52px;border-radius:50%;background:rgba(216,90,48,.14);color:#C04A22;font-weight:700;font-size:18px;display:flex;align-items:center;justify-content:center;flex-shrink:0">I</div>
        <?php endif; ?>
        <div>
...
<div class="elab-section alt reveal" id="equipe" style="text-align:center">
  ...
  <div class="equipe-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:28px;max-width:1000px;margin:0 auto 48px">
    ...
    <div style="background:#fff;border:1px solid #fde68a;border-radius:20px;overflow:hidden;box-shadow:0 6px 28px rgba(0,0,0,.08);transition:transform .25s,box-shadow .25s" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 16px 40px rgba(0,0,0,.14)'" onmouseout="this.style.transform='none';this.style.boxShadow='0 6px 28px rgba(0,0,0,.08)'">
      ...
      <div style="padding:22px 20px 20px">
        ...
        <div style="display:flex;gap:8px">
          <a href="https://facebook.com/" target="_blank" rel="noopener" style="flex:1;display:flex;align-items:center;justify-content:center;background:#EFF6FF;border-radius:8px;padding:9px;color:#1877F2;text-decoration:none"><i class="ti ti-brand-facebook" style="font-size:18px"></i></a>
          <a href="https://wa.me/" target="_blank" rel="noopener" style="flex:1;display:flex;align-items:center;justify-content:center;background:#F0FDF4;border-radius:8px;padding:9px;color:#16a34a;text-decoration:none"><i class="ti ti-brand-whatsapp" style="font-size:18px"></i></a>
          <a href="https://linkedin.com/in/" target="_blank" rel="noopener" style="flex:1;display:flex;align-items:center;justify-content:center;background:#EFF6FF;border-radius:8px;padding:9px;color:#0A66C2;text-decoration:none"><i class="ti ti-brand-linkedin" style="font-size:18px"></i></a>
        </div>
      </div>
    </div>
    ...
    <div style="background:#fff;border:1px solid #fde68a;border-radius:20px;overflow:hidden;box-shadow:0 6px 28px rgba(0,0,0,.08);transition:transform .25s,box-shadow .25s" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 16px 40px rgba(0,0,0,.14)'" onmouseout="this.style.transform='none';this.style.boxShadow='0 6px 28px rgba(0,0,0,.08)'">
      <div style="height:240px;background:linear-gradient(160deg,#1A1A18 0%,#C04A22 100%);display:flex;align-items:center;justify-content:center;position:relative">
        <img src="<?= SITE_URL ?>/assets/images/equipes/4.jpeg" alt="Carine GNAMOU"
             onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"
             style="width:100%;height:100%;object-fit:cover;object-position:top;display:block">
        <div style="display:none;width:120px;height:120px;border-radius:50%;background:rgba(255,255,255,.2);backdrop-filter:blur(4px);border:4px solid rgba(255,255,255,.5);align-items:center;justify-content:center;font-size:42px;font-weight:700;color:#fff;position:absolute">CG</div>
        <div style="position:absolute;bottom:14px;left:14px;background:rgba(0,0,0,.55);backdrop-filter:blur(6px);border-radius:8px;padding:5px 12px">
          <div style="font-size:11px;font-weight:700;color:#fbbf24">Chargée de communication au sein de CPID Ariziki</div>
        </div>
      </div>
      <div style="padding:22px 20px 20px">
        <div style="font-size:17px;font-weight:700;color:#1A1A18;margin-bottom:8px">Carine GNAMOU</div>
        <p style="font-size:13px;color:#6b7280;line-height:1.7;margin-bottom:18px">
          Chargée de communication au sein de CPID Ariziki, elle est responsable de la valorisation des actions de l'organisation à travers la création de contenus, la gestion des canaux de communication et la diffusion des informations auprès des différents publics afin de renforcer la visibilité et l'impact des activités de l'ONG.
        </p>
        <div style="display:flex;gap:8px">
          <a href="https://facebook.com/" target="_blank" rel="noopener" style="flex:1;display:flex;align-items:center;justify-content:center;background:#EFF6FF;border-radius:8px;padding:9px;color:#1877F2;text-decoration:none"><i class="ti ti-brand-facebook" style="font-size:18px"></i></a>
          <a href="https://wa.me/" target="_blank" rel="noopener" style="flex:1;display:flex;align-items:center;justify-content:center;background:#F0FDF4;border-radius:8px;padding:9px;color:#16a34a;text-decoration:none"><i class="ti ti-brand-whatsapp" style="font-size:18px"></i></a>
    ...
    <div style="background:#fff;border:1px solid #fde68a;border-radius:20px;overflow:hidden;box-shadow:0 6px 28px rgba(0,0,0,.08);transition:transform .25s,box-shadow .25s" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 16px 40px rgba(0,0,0,.14)'" onmouseout="this.style.transform='none';this.style.boxShadow='0 6px 28px rgba(0,0,0,.08)'">
      <div style="height:240px;background:linear-gradient(160deg,#1A1A18 0%,#C04A22 100%);display:flex;align-items:center;justify-content:center;position:relative">
        <img src="<?= SITE_URL ?>/assets/images/equipes/5.jpeg" alt=""
             onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"
             style="width:100%;height:100%;object-fit:cover;object-position:top;display:block">
        <div style="display:none;width:120px;height:120px;border-radius:50%;background:rgba(255,255,255,.2);backdrop-filter:blur(4px);border:4px solid rgba(255,255,255,.5);align-items:center;justify-content:center;font-size:42px;font-weight:700;color:#fff;position:absolute">SA</div>
        <div style="position:absolute;bottom:14px;left:14px;background:rgba(0,0,0,.55);backdrop-filter:blur(6px);border-radius:8px;padding:5px 12px">
          <div style="font-size:11px;font-weight:700;color:#fbbf24">Spécialiste en Économie Agricole</div>
        </div>
      </div>
      <div style="padding:22px 20px 20px">
        <div style="font-size:17px;font-weight:700;color:#1A1A18;margin-bottom:8px"></div>
        <p style="font-size:13px;color:#6b7280;line-height:1.7;margin-bottom:18px">
          Spécialiste en Économie Agricole passionné par le développement des territoires, j'accompagne depuis plus de trois (03) ans les entrepreneurs du Nord Bénin à structurer leur offre, conquérir de nouveaux marchés et transformer leurs projets en entreprises viables et durables.
        </p>
        <div style="display:flex;gap:8px">
          <a href="https://facebook.com/" target="_blank" rel="noopener" style="flex:1;display:flex;align-items:center;justify-content:center;background:#EFF6FF;border-radius:8px;padding:9px;color:#1877F2;text-decoration:none"><i class="ti ti-brand-facebook" style="font-size:18px"></i></a>
          <a href="https://wa.me/" target="_blank" rel="noopener" style="flex:1;display:flex;align-items:center;justify-content:center;background:#F0FDF4;border-radius:8px;padding:9px;color:#16a34a;text-decoration:none"><i class="ti ti-brand-whatsapp" style="font-size:18px"></i></a>
  ...
  <div style="max-width:1100px;margin:0 auto;padding:40px 32px 0">
    <div class="footer-grid" style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px;margin-bottom:40px">
      <div>
        ...
        <p style="font-size:13px;color:rgba(255,255,255,.5);line-height:1.75;margin-bottom:16px">
          Lancez votre entreprise avant votre diplôme.<br>Certificat cosigné par les plus grandes Universités du Bénin.
        </p>
        <div style="display:flex;gap:10px">
          <a href="#" style="width:34px;height:34px;background:rgba(255,255,255,.08);border-radius:8px;display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,.6);text-decoration:none"><i class="ti ti-brand-facebook" style="font-size:17px"></i></a>
          <a href="#" style="width:34px;height:34px;background:rgba(255,255,255,.08);border-radius:8px;display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,.6);text-decoration:none"><i class="ti ti-brand-whatsapp" style="font-size:17px"></i></a>
          <a href="#" style="width:34px;height:34px;background:rgba(255,255,255,.08);border-radius:8px;display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,.6);text-decoration:none"><i class="ti ti-brand-linkedin" style="font-size:17px"></i></a>
        </div>
      </div>
      <div>
        ...
        <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:9px">
          <li><a href="<?= SITE_URL ?>/index.php#parcours" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Le Parcours</a></li>
          <li><a href="<?= SITE_URL ?>/index.php#tarifs" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Tarifs</a></li>
          <li><a href="<?= SITE_URL ?>/index.php#equipe" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">À propos</a></li>
          <li><a href="<?= SITE_URL ?>/contact.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Contact</a></li>
          <li><a href="<?= SITE_URL ?>/rgpd.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Mentions légales</a></li>
        </ul>
      </div>
      <div>
        ...
        <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:9px">
          <li><a href="<?= SITE_URL ?>/auth.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Se connecter</a></li>
          <li><a href="<?= SITE_URL ?>/auth.php?mode=signup" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">S'inscrire</a></li>
          <li><a href="<?= SITE_URL ?>/dashboard.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Mon espace</a></li>
          <li><a href="<?= SITE_URL ?>/payment.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Abonnement</a></li>
          <li><a href="<?= SITE_URL ?>/resources.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Bibliothèque</a></li>
        </ul>
      </div>
      <div>
        ...
        <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:9px">
          <li><a href="<?= SITE_URL ?>/rgpd.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Confidentialité</a></li>
          <li><a href="<?= SITE_URL ?>/rgpd.php" style="font-size:13px;color:rgba(255,255,255,.55);text-decoration:none">Mentions légales</a></li>
        </ul>
      </div>
    </div>
    <div style="border-top:1px solid rgba(255,255,255,.08);padding:20px 0;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px">
      ...
      <p style="font-size:12px;color:rgba(255,255,255,.3)">
        Fait par
        <a href="https://aichaporfolio.vercel.app/" target="_blank" rel="noopener" style="color:#D85A30;text-decoration:none;font-weight:600">Aïchatou BIO SANNA</a>
      </p>
    </div>
  </div>
</footer>
