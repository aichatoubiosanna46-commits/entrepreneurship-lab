...
$tarifs = [
  ...
  'serie_1_2' => [
    ...
    'emoji'   => 'ti-chart-bar',
    'nom'     => 'Séries 1 + 2',
    'accroche'=> 'De l\'idée à ta première vente',
    'desc'    => 'Le cœur du programme pour les étudiants en action : valider ton idée, lancer et vendre.',
    'prix'    => 15000,
    'badge'   => '<i class="ti ti-star-filled"></i> Le plus choisi',
    'badge_cls'=> 'pop',
    'thumb'   => 't2',
    'btn_cls' => 'gold',
    'featured'=> true,
    'avantages'=> [
      '18 modules (Séries 1 & 2)',
      'Tous les templates & outils',
      'Coaching mensuel en groupe',
      'Certification Université de Parakou',
      'Paiement par tranches possible',
    ],
    'non'     => [],
  ],
  'parcours_complet' => [
